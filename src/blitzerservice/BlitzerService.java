...
public class BlitzerService {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Runnable task = new HttpFetcher(props.getProperty("url"), Integer.parseInt(props.getProperty("timeoutSec")), props.getProperty("keywords"));
        ...
        //final ScheduledFuture<?> taskHandle = scheduler.scheduleAtFixedRate(task, 0, 8, java.util.concurrent.TimeUnit.SECONDS);
